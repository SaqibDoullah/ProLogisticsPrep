        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <stat.icon className="h-12 w-12 text-[var(--primary-light-blue)] mx-auto mb-4" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              ...
              >
                <value.icon className="h-12 w-12 text-[var(--primary-light-blue)] mx-auto mb-4" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <div className="text-[var(--primary-light-blue)] font-medium mb-3">{member.role}</div>
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-[var(--primary-light-blue)] rounded-full"></div>
