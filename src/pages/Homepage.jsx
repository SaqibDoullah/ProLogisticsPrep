          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button 
                ...
                size="lg"
                className="btn-orange text-white font-semibold rounded-full shadow-lg transition-transform hover:scale-105"
              >
                Get a Free Quote
          ...
          >
            {trustBadges.map((badge, index) => (
              <div key={index} className="flex flex-col items-center text-center space-y-2">
                <badge.icon className="h-8 w-8 text-accent-green" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                className="glass-effect p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
              >
                <service.icon className="h-12 w-12 text-accent-green mb-4" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <img 
                ...
                alt="Prep services"
               src="/prep services.jpeg" />
              <div className="absolute -bottom-6 -right-6 bg-accent-dark-green text-white p-4 rounded-xl shadow-lg">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
              <div className="glass-effect p-6 rounded-xl">
                <div className="text-2xl font-bold text-accent-green">$0.50</div>
                <div className="text-sm text-gray-300">per item FBA prep</div>
              </div>
              <div className="glass-effect p-6 rounded-xl">
                <div className="text-2xl font-bold text-accent-orange">$2.00</div>
                <div className="text-sm text-gray-300">per order fulfillment</div>
              </div>
              <div className="glass-effect p-6 rounded-xl">
                <div className="text-2xl font-bold text-gray-300">$0.25</div>
                <div className="text-sm text-gray-300">per item per month storage</div>
              </div>
            </div>
            <Button 
